...
local function _set_cursor_style()
  opt.guicursor =
  'n-v-c:block-blinkwait700-blinkon400-blinkoff250-Cursor,i-ci-ve:ver25-blinkwait700-blinkon400-blinkoff250-Cursor,r-cr-o:hor20-blinkwait700-blinkon400-blinkoff250-Cursor'
  ...
  local augroup = vim.api.nvim_create_augroup('CursorStyle', { clear = true })
...
local function sync_alac_bg()
  ...
  local terminal_group = vim.api.nvim_create_augroup('TerminalBgSync', { clear = true })
...
local function set_keymap()
  ...
  keyset('t', '<C-[>', [[<C-\><C-n>]], { desc = 'Exit terminal mode' })
